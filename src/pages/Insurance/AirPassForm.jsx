        ...
        <div className="w-full max-w-[900px]">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-[520px] text-[13px] leading-6 text-[#DBEAFE]">
              Flight delays, cancellations and missed
              connections covered instantly.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div className="rounded-[22px] border border-white/10 bg-white/10 p-5 backdrop-blur-md">
              ...
              <p className="mt-3 text-[13px] leading-6 text-[#E0E7FF]">
                ...
                missed boarding and cancellations.
              </p>
            ...
            <div className="rounded-[22px] border border-white/10 bg-white/10 p-5 backdrop-blur-md">
              ...
              <div className="mt-5">
                ...
                {/* BUTTON */}
                <button className="mt-5 flex h-[48px] w-full items-center justify-center gap-2 rounded-[16px] bg-white text-[13px] font-bold text-[#111827] transition-all duration-300 hover:scale-[1.02]">
                  Continue
