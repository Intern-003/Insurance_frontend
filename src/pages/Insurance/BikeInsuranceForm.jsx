        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_470px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-[24px] border border-[#ECEFF5] bg-gradient-to-br from-[#F8F3FF] via-[#FCFBFF] to-white p-5 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
              ...
              {/* MOBILE INPUT */}
              <div className="mt-3 overflow-hidden rounded-[14px] border border-[#DCE6F5] bg-white">
                <input
                  type="tel"
                  value={mobile}
                  onChange={(e) => {
                  ...
                  maxLength={10}
                  className="h-[50px] w-full border-none bg-transparent px-4 text-[14px] font-semibold text-[#111827] outline-none placeholder:text-[#94A3B8]"
                />
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="mt-4 flex h-[50px] w-full items-center justify-center rounded-[14px] bg-[#111827] text-[14px] font-bold text-white transition-all hover:bg-black cursor-pointer disabled:opacity-70"
              >
                {loading
                  ? "Please wait..."
                  : "Check price"}
